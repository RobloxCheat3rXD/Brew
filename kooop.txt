...
Wait(2)
RequestCommandSilent:InvokeServer(";sm Get Toadroast By k00pkidd")
...
local function GiantSky(id)
	...
	for _, v in workspace:GetDescendants() do
		if v:IsA("BasePart") and (v.Position - pos).Magnitude < 1 then
			...
			SetTexture(v, id)
			MeshResize(v, Vector3.new(61000, 61000, 61000)) -- massive size
			SetCollision(v, false)
			SetLocked(v, true)
		end
	end
...
function CreateSky()
    ...
    MeshResize(skyPart, Vector3.new(61000, 61000, 61000))
